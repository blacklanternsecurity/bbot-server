...
class TestAppletTechnologies(BaseAppletTest):
    ...
    async def setup(self):
        ...
        assert await self.bbot_server.get_technologies_for_host("t1.tech.evilcorp.com") == []
        assert await self.bbot_server.get_technologies_for_host("t2.tech.evilcorp.com") == []
    ...
    async def after_scan_1(self):
        ...
        tech1 = await self.bbot_server.get_technologies_for_host("t1.tech.evilcorp.com")
        assert len(tech1) == 2
        ...
        tech2 = await self.bbot_server.get_technologies_for_host("t2.tech.evilcorp.com")
        assert len(tech2) == 1
